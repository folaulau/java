...
//		return "4000000000000069"; // Charge is declined with an expired_card code.
	...
	public static User generateUser() {
		...
		user.setPhone(getRandomPhoneNumber());
		user.setAge(RandomGeneratorUtils.getIntegerWithin(1, 50));
	...
	public static Member generateMember() {
		...
		member.setGender(getRandomGender());
		member.setName(getRandomFirstname() + " " + getRandomLastname());
		member.setPhone(getRandomPhoneNumber());
		member.setAge(RandomGeneratorUtils.getIntegerWithin(1, 50));
	...
	private static String getRandomPhoneNumber() {
		return "310" + RandomGeneratorUtils.getIntegerWithin(100, 999) + ""
	...
	public static String getRandomEmail(String name, String slug) {
		...
		if (slug == null) {
			...
			email = name + slug + "+" + RandomGeneratorUtils.getIntegerWithin(1, Integer.MAX_VALUE - 1) + "@gmail.com";
		}
		return email;
	}
